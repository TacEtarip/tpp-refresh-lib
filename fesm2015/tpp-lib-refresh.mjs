...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TppLibRefreshService, [{
            type: Injectable
        }], function () {
...
TppLibRefreshComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: TppLibRefreshComponent, selectors: [["lib-tpp-lib-refresh"]], decls: 2, vars: 0, template: function TppLibRefreshComponent_Template(rf, ctx) {
        if (rf & 1) {
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TppLibRefreshComponent, [{
            type: Component,
            args: [{
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TppLibRefreshModule, [{
            type: NgModule,
            args: [{
